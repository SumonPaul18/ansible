...
10. [ইনস্টলেশনের পরে কনফিগারেশন](#ইনস্টলেশনের-পরে-কনফিগারেশন)
...
## **ইনস্টলেশনের পরে কনফিগারেশন** <a id="ইনস্টলেশনের-পরে-কনফিগারেশন"></a>
...
### **ফোল্ডার তৈরি করা**
সব সার্ভারে `/tmp/test` ফোল্ডার তৈরি করুন:
```bash
...
### **প্লেবুক লেখা**
উদাহরণ: Apache ইনস্টল এবং স্টার্ট করা।

ফাইল: `install_apache.yml`
```yaml
---
...
### **রোল ব্যবহার**
প্লেবুক রিইউজেবল রোলে সংগঠিত করুন। উদাহরণ ডিরেক্টরি স্ট্রাকচার:
```
roles/
  common/
    tasks/
...
### **ডাইনামিক ইনভেন্টরি**
AWS, Azure ইত্যাদি ক্লাউড প্রোভাইডার থেকে সার্ভারের তালিকা পেতে ডাইনামিক ইনভেন্টরি স্ক্রিপ্ট ব্যবহার করুন।
